...
fn main() {
    ...
    //
    let (left, right) = coords;

    print_difference(left, right); // Uncomment and finish this line
    ...
    //
    let coords_arr: [f32; 2] = [left, right]; // create an array literal out of parts of `coord` here
